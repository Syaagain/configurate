...
// Papierflieger Geometrie erstellen
function createPaperPlaneGeometry(scale = 1) {
    const geometry = new THREE.BufferGeometry();
    
    // Papierflieger Vertices
    const vertices = new Float32Array([
        // Hauptkörper (Dreieck)
        0, 0, 2 * scale,     // Spitze vorne
        -1.5 * scale, 0, -1 * scale,   // Links hinten
        1.5 * scale, 0, -1 * scale,    // Rechts hinten
        
        // Linker Flügel
        0, 0, 2 * scale,     // Spitze vorne
        -1.5 * scale, 0, -1 * scale,   // Links hinten
        -2.5 * scale, 0.2 * scale, 0,  // Linke Flügelspitze
        
        // Rechter Flügel
        0, 0, 2 * scale,     // Spitze vorne
        1.5 * scale, 0, -1 * scale,    // Rechts hinten
        2.5 * scale, 0.2 * scale, 0,   // Rechte Flügelspitze
        
        // Stabilisator
        -0.5 * scale, 0.3 * scale, -1 * scale,  // Links oben
        0.5 * scale, 0.3 * scale, -1 * scale,   // Rechts oben
        0, 0.5 * scale, -1.5 * scale,           // Oben hinten
    ]);
